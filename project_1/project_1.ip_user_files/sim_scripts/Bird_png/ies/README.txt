...
#
# Generated by export_simulation on Fri Jul 29 20:14:21 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './Bird_png.sh' script.

./Bird_png.sh -reset_run
...
./Bird_png.sh -noclean_files

For more information on the script, please type './Bird_png.sh -help'.
