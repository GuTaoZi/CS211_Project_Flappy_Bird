...
#
# Generated by export_simulation on Fri Jul 29 20:19:07 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './TubeBody_png.sh' script.

./TubeBody_png.sh -reset_run
...
./TubeBody_png.sh -noclean_files

For more information on the script, please type './TubeBody_png.sh -help'.
