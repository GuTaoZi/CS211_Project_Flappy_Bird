...
#
# Generated by export_simulation on Fri Jul 29 20:17:29 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './TubeHead_png.sh' script.

./TubeHead_png.sh -reset_run
...
./TubeHead_png.sh -noclean_files

For more information on the script, please type './TubeHead_png.sh -help'.
